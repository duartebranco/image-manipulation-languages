...
class iimlVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by iimlParser#shapeSize.
    def visitShapeSize(self, ctx:iimlParser.ShapeSizeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by iimlParser#forStatement.
    def visitForStatement(self, ctx:iimlParser.ForStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by iimlParser#forControl.
    def visitForControl(self, ctx:iimlParser.ForControlContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by iimlParser#forType.
    def visitForType(self, ctx:iimlParser.ForTypeContext):
        return self.visitChildren(ctx)
