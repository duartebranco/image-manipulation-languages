...
public interface imlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link imlParser#functionDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionDecl(imlParser.FunctionDeclContext ctx);
	/**
	 * Visit a parse tree produced by {@link imlParser#paramList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParamList(imlParser.ParamListContext ctx);
	/**
	 * Visit a parse tree produced by {@link imlParser#param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParam(imlParser.ParamContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link imlParser#exitStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExitStatement(imlParser.ExitStatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link imlParser#tryCatchStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTryCatchStatement(imlParser.TryCatchStatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code unaryPixelBoolOperationExpr}
	 * labeled alternative in {@link imlParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnaryPixelBoolOperationExpr(imlParser.UnaryPixelBoolOperationExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCallExpr(imlParser.FunctionCallExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code numberConversionExpr}
	 * labeled alternative in {@link imlParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNumberConversionExpr(imlParser.NumberConversionExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code allPixelExpr}
	 * labeled alternative in {@link imlParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAllPixelExpr(imlParser.AllPixelExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code unaryPixelOperationExpr}
	 * labeled alternative in {@link imlParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnaryPixelOperationExpr(imlParser.UnaryPixelOperationExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitArithmeticExpr(imlParser.ArithmeticExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code pixelBoolOperationExpr}
	 * labeled alternative in {@link imlParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPixelBoolOperationExpr(imlParser.PixelBoolOperationExprContext ctx);
	/**
